		...
		<>
			<div className="history-list-wrapper">
				<div className="history-header">
					<div className="headers history-creationDate"><h4>Creation Date </h4></div>
					<div className="headers history-category"><h4>Category</h4></div>
					<div className="headers history-description"><h4>Goal Description</h4></div>
					<div className="headers history-review"><h4>End of year review</h4></div>
					<div className="headers history-deadline"><h4 className="deadline">Deadline</h4></div>
						...
						{completedGoals.map((goal, i) => (
							<li key={i} className="history-list-item">
								...
								<div className="body history-category">
									<p>{goal.category.replace(/([a-z])([A-Z])/g, '$1 $2').toUpperCase()}</p>
								</div>
